...
const Footer = () => {
  return (
    <footer className="bg-himlam-800 text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+84901234567" className="text-himlam-100 hover:text-white transition-colors">
                  090 123 4567
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-himlam-300" />
                <a href="mailto:contact@himlam.vn" className="text-himlam-100 hover:text-white transition-colors">
                  contact@himlam.vn
                </a>
              </li>
            </ul>
